...
namespace HalalOnTheGo.Server.Migrations
{
    ...
    [Migration("20240225135315_Seeding")]
            ...
            modelBuilder.Entity("HalalOnTheGo.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6168),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6525),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6530),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Indulge in the unparalleled quality and authenticity of our halal butchered chicken breasts, where tradition meets excellence. Sourced from ethically-raised, halal-certified poultry, our chicken breasts are meticulously prepared to meet the highest standards of halal butchering. Each tender and succulent piece is carefully hand-selected, ensuring a premium dining experience that aligns with your dietary preferences.",
                            Image = "/Images/chickenbreast1KG.png",
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 1,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6535),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 1,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6539),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 1,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6542),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Delight your senses with our premium HALAL chicken drumsticks, now available for purchase on our website. Sourced from trusted and ethical producers, our HALAL-certified chicken drumsticks offer a perfect balance of quality, flavor, and convenience.",
                            Image = "/Images/Chicken-Drumsticks.png",
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 7,
                            CategoryId = 1,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6545),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Delight your senses with our premium HALAL chicken drumsticks, now available for purchase on our website. Sourced from trusted and ethical producers, our HALAL-certified chicken drumsticks offer a perfect balance of quality, flavor, and convenience.",
                            Image = "/Images/Chicken-Drumsticks.png",
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 8,
                            CategoryId = 1,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6549),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 9,
                            CategoryId = 1,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6553),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Discover the convenience and versatility of our halal chicken mince, now available for purchase on our website. Sourced from trusted producers and crafted with care, our halal chicken mince provides a wholesome and flavorful option for a variety of culinary creations.",
                            Image = "/Images/Chicken-Mix-Mince.png",
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 10,
                            CategoryId = 2,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6557),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 11,
                            CategoryId = 2,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6560),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 12,
                            CategoryId = 2,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6563),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Savor the exquisite taste of our Halal Butchered Lamb Chops, a culinary delight crafted with the utmost respect for halal principles. Our lamb chops are meticulously               sourced from ethically-raised, halal-certified lambs, ensuring that every succulent bite adheres to the highest standards of halal butchering.",
                            Image = "/Images/LambChops1kg.png",
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 13,
                            CategoryId = 2,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6567),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 14,
                            CategoryId = 2,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6570),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 15,
                            CategoryId = 2,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6574),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 16,
                            CategoryId = 3,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6577),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 17,
                            CategoryId = 3,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6580),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Elevate your culinary adventures with our premium diced with bone mutton, a tantalizing symphony of flavor and tenderness that promises to redefine your dining experience. Sourced from the finest pastures and carefully selected for its exceptional quality, our mutton is a testament to the artistry of butchery.",
                            Image = "/Images/Dice-Mutton.png",
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 18,
                            CategoryId = 3,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6584),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 19,
                            CategoryId = 3,
                            DateCreated = new DateTime(2024, 2, 25, 13, 53, 15, 659, DateTimeKind.Local).AddTicks(6587),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
